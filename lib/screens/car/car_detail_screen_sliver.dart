...
class CarDetailScreenSliver extends StatefulWidget {
  const CarDetailScreenSliver({
    super.key,
    required this.car,
  ...
  _CarDetailScreenSliverState createState() => _CarDetailScreenSliverState();
}

class _CarDetailScreenSliverState extends State<CarDetailScreenSliver> {
