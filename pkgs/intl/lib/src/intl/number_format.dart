...
class NumberFormat {
  ...
  // (alanknight): Handle currency formats which are specified in a raw
  ...
  // (alanknight): Should we allow decimalDigits on other numbers.
  ...
  // (alanknight): Do we have a MaxInt constant we could use instead?
